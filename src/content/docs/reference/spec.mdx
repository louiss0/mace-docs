...
literal creates a record, a nested record literal creates a nested record, and  
array collects values in order. Static semantics determine whether the resulting  
construction is legal before the value is accepted as Mace data.
