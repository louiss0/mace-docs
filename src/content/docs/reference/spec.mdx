...
`float`, `boolean`, `array`, `fusion`, `variant`, `nullable`, `parse`,
...
Mace expressions are pure and deterministic. The implementation supports identifiers, member access, literals, array literals, record literals, `$self`, unary operators, arithmetic operators, comparison operators, equality operators, bitwise operators, logical operators, and ternary conditionals.
